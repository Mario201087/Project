...
<html lang="en">
  ...
  <section class="container-fluid" style="background-color: #8fc4b7;height:92%;">
  <div class="col12 h-25"></div>
          ...
          <div class="card-body p-4 p-md-5">
            ...
            <form action="picture.php" method="post" enctype="multipart/form-data">
               <div class="row d-flex ">
                ...
                <div class="row d-flex ">
                    <div class="col p-1">
                     <input type="file" class="col-12 btn btn-primary"  name="plik">
                    </div>
                </div>
                <div class="row d-flex ">
                    <div class="col p-1">
                     <input type="submit" name="submit" class="btn btn-primary col-12" value="Upload">
                    </div>
                </div>
            </form>
          </div>
