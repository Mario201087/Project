...
--
-- Host: 127.0.0.1
-- Generation Time: Lip 12, 2023 at 12:32 PM
...
-- Database: `project`
--
CREATE DATABASE IF NOT EXISTS `project` DEFAULT CHARACTER SET utf8 COLLATE utf8_polish_ci;
USE `project`;
...
CREATE TABLE `users` (
  ...
  `class` int(70) DEFAULT NULL,
  `school` varchar(70) DEFAULT NULL,
  `permissions` varchar(70) DEFAULT NULL
